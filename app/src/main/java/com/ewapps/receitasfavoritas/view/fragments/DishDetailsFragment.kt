...
import com.ewapps.receitasfavoritas.databinding.FragmentDishDetailsBinding
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        ...
        when (item.itemId) {
            R.id.action_share_dish -> {
                ...
                val type = "text/plain"
                val subject = "Veja esta receita"
                var extraText = ""
                val shareWith = "Compartilhar com"

                mFavDishDetails?.let {
                    var image = ""
                    if(it.imageSource == com.ewapps.receitasfavoritas.utils.Constants.DISH_IMAGE_SOURCE_ONLINE ) {
                        image = it.image
                    }
                    ...
                    extraText =
                        "$image \n" +
                                ...
                                "\n\n Ingredientes: \n ${it.ingredients} \n\n Modo de fazer: " +
                                "\n ${cookingInstructions} \n\n Tempo aproximado para fazer esta receita ${it.cookingTime} minutos."
                }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
                ...
                Glide.with(requireActivity())
                    ...
                    .listener(object : RequestListener<Drawable>{
                        ...
                        override fun onResourceReady(
                            ...
                            resource?.let { it1 ->
                                Palette.from(it1.toBitmap()).generate() { palette ->
        ...
        mBinding!!.ivFavoriteDish.setOnClickListener {
            ...
            if(args.dishDetails.favoriteDish){
                ...
                Toast.makeText(requireActivity(), getString(R.string.msg_added_to_favorites), Toast.LENGTH_SHORT).show()
            }else{
                mBinding!!.ivFavoriteDish.setImageDrawable(ContextCompat.getDrawable(
                    requireActivity(),
                    R.drawable.ic_favorite_unselected
                ))
                Toast.makeText(requireActivity(), getString(R.string.msg_removed_from_favorite), Toast.LENGTH_SHORT).show()
            }
        }
